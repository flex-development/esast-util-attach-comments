...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/esast-util-attach-comments
   cd esast-util-attach-comments
   ```
...
```sh
https://github.com/flex-development/esast-util-attach-comments/compare/main...$branch
```
...
[discussion-qa]: https://github.com/flex-development/esast-util-attach-comments/discussions/new?category=q-a
